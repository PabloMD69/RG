	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			...
			"A: Oh~ That's interesting."
			    ,
		     "O: Yah and i will like to give special thanks to Hanson Delali,Romeo Ankamah, Agbitsu Fred, Karien Amoateng, Fiate Emmanuel, Dzogbewu and everyone for the Ideas and Inspirations much luv..."
		     ,
		];
